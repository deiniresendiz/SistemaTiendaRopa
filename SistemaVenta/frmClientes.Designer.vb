...
Partial Class frmClientes
    ...
    Private Sub InitializeComponent()
        ...
        Me.ClientesTableAdapter = New SistemaVenta.DataSet1TableAdapters.ClientesTableAdapter()
